# -*- coding: utf-8 -*-
# 最終更新 2025.12.30 2100 ベータ版　一応復元版 サイドバーのグラフ設定が効かないもの
...
def main():
    ...
    st.markdown(f"""
        <style>
            ...
            h1 {{ margin-top: 0px !important; margin-bottom: -5px !important; line-height: 1.0 !important; }}
