...
if use_map:
    st.info("地図をドラッグして動かしてください。常に【中心（赤色の＋マーカー）】の座標が予報地点になります。")
    ...
    # 地図の描画と中心座標の取得
    map_out = st_folium(m, width="100%", height=400, key="main_map")
