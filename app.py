# -*- coding: utf-8 -*-
# 正規版　更新 2026.1.16 2350 Logo 既定場所追加 翻訳拒否 コンプリート版
"""
...
"LOCATION_MASTER": {
        ...
        "住吉浜沖(大分県)": (33.424, 131.649),
        "逗子海岸沖(神奈川県)": (35.293, 139.571),
        "津久井浜沖(神奈川県)": (35.190, 139.676),
        "御前崎沖(静岡県)": (34.597, 138.225),
        "本栖湖中央(山梨県)": (35.474, 138.588),
        "浜名湖村櫛沖(静岡県)": (34.750, 137.600),
        "甲子園浜沖(兵庫県)": (34.708, 135.359),
        "柏原沖(鹿児島県)": (31.380, 131.020), 
        "磯海岸沖(鹿児島県)": (31.614, 130.577), 
        "江口浜沖(鹿児島県)": (31.643, 130.322),
        "垂水港(鹿児島県)": (31.478, 130.668), 
        "海潟(鹿児島県)": (31.539, 130.706), 
        "カナハ沖(マウイ島)": (20.905, -156.441),
        "ポゾ沖(グランカナリア)": (27.822, -15.420),
        "グリュイッサン沖(DEFI)": (43.102, 3.095),
        "アンスバタ沖(ニューカレドニア)": (-22.307, 166.442),
